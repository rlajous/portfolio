const technologies = [
  ...
  },
  {
    name: 'Node.js',
    img: 'node',
    description: 'Is a runtime environment for JavaScript built with Chrome\'s V8 JavaScript engine.',
    time: '3 Years'
  },
  {
    name: 'Angular',
    img: 'angular',
    description: 'Is a framework for web applications developed in TypeScript, open source, maintained by Google, which is used to create and maintain single page web applications.',
    time: '1 Year'
  },
  {
    name: 'Vue.js',
